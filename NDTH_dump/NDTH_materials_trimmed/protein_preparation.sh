...
## bash protein_preparation.sh
###############################################################################################################################################################

root_dir=/nfs_home/users/ndth/projects/protraction/GLP-1R/GLP1_GLP1R_SEM
target_dir=$1
PDB_dir=$2
...
python ${root_dir}/Rosetta2GMX_full.py ${input_PDB} ${root_dir}/SEM.pdb ./Rosetta2GMX_output.pdb 100 229
...
# --------- everything remains same from here --------------
